...
| Independent product feedback | `visp critic --preflight` | Setup-needed means inspect capabilities; ready means prepare/delegate/submit, or dispatch through an attached adapter. |
| Manual feedback enabled; first usable slice or consequential design uncertainty | `visp critic feedback --ask "What should I improve in this version?"` | Use the host user-question popup; submit the user's words. Defer without approval; continue unrelated work. |
